...
while True:
    try:
        ...
        with open(fr'C:\Users\ead\Documents\LOGICA_PROGRAMACAO_AULAS\AULA_05/{nome_arquivo}.txt', 'a', encoding='utf=8') as f:
            f.write(texto2)
        print('Gravado com sucesso')

        #ler os dados atualizados

        with open(fr'C:\Users\ead\Documents\LOGICA_PROGRAMACAO_AULAS\AULA_05/{nome_arquivo}.txt', 'r', encoding='utf=8') as f:
            arquivoaberto = f.read()

        print(arquivoaberto,' Essa é a informação contida dentro do arquivo modificado') 
